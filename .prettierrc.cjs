module.exports = {
  semi: false, // 语句末尾是否加分号，默认 true
  singleQuote: false, // 是否使用单引号，默认 false
  printWidth: 100, // 每行最大字符数，默认 80
  tabWidth: 2, // 缩进空格数，默认 2
  useTabs: false, // 是否使用 Tab 缩进，默认 false
  trailingComma: "none", // 多行结构是否加尾逗号，可选值：none, es5, all
